...
2. Create an `EditText` to enter the website URL and a **Navigate** button.
3. Read the URL entered by the user when the button is clicked.
4. Create an implicit intent using `Intent.ACTION_VIEW` with the entered URL.
5. Launch the intent to open the URL in a web browser.
6. Display the requested webpage (e.g., `https://www.gmail.com`).
